...
require github.com/bmc-toolbox/common v0.0.0-20250112191656-b6de52e8303d
...
require (
	...
	k8s.io/cri-api v0.35.5 // indirect
	...
	k8s.io/endpointslice v0.35.5 // indirect
	k8s.io/externaljwt v0.35.5 // indirect
	k8s.io/kms v0.35.5 // indirect
	k8s.io/kube-aggregator v0.35.5 // indirect
	k8s.io/kube-controller-manager v0.35.5 // indirect
	k8s.io/kube-openapi v0.0.0-20250910181357-589584f1c912 // indirect
	k8s.io/kube-proxy v0.35.5 // indirect
	...
	k8s.io/mount-utils v0.35.5 // indirect
...
replace (
	// Local dev: forked bmclib with the Lenovo XCC provider
	// (branch feature/provider-lenovo). Replace with a tagged
	// pseudo-version before release.
	github.com/bmc-toolbox/bmclib/v2 => ../bmclib
